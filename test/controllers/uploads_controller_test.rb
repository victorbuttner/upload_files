...
class UploadsControllerTest < ActionController::TestCase
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post :create, upload: { description: @upload.description, user_id: @upload.user_id }
    end
  ...
  test "should update upload" do
    patch :update, id: @upload, upload: { description: @upload.description, user_id: @upload.user_id }
    assert_redirected_to upload_path(assigns(:upload))
  end
